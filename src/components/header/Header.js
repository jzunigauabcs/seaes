...
import logoUan from '../../assets/images/logoUAN.JPG';
  ...
  return(
    ...
    <header>
      ...
      <Col className={`logos d-flex justify-content-center align-items-center`} >
        ...
        <Image className="logos-oficiales" src={logoUABCS}/>
        <Image className="logos-oficiales" src={logoUas}/>
        <Image className="logos-oficiales" src={logoUan}/>
      </Col>
       <Col className="title">
